...
export const selfEsteemRecommendedTools = [
  {
    id: 1,
    title: 'Дневник самооценки и самосострадания',
    description: 'Отслеживайте моменты самокритики и практикуйте поддерживающий внутренний диалог.',
    type: 'дневник',
    icon: Heart,
    category: 'Самоподдержка',
    link: '/diaries/self-esteem'
  },
  {
    id: 2,
    title: 'Практика осознанности мыслей',
    description: 'Развивайте навык замечать автоматические критические мысли без осуждения.',
    type: 'практика',
    icon: Brain,
  ...
  {
    id: 3,
    title: 'Анализ глубинных убеждений о себе',
    description: 'Исследуйте и трансформируйте базовые представления о собственной ценности.',
    type: 'упражнение',
    icon: Target,
    category: 'Самоанализ',
    link: '/practices'
  ...
  {
    id: 4,
    title: 'Тест самооценки Розенберга',
    description: 'Классический инструмент для измерения уровня глобальной самооценки.',
    type: 'тест',
    icon: Users,
  ...
  {
    id: 5,
    title: 'Техники самосострадания Кристин Нефф',
    description: 'Структурированные практики развития доброжелательного отношения к себе.',
    type: 'упражнение',
    icon: Shield,
