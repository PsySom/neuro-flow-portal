            ...
            <CardContent className="p-8">
              ...
              <div className="prose prose-lg max-w-none dark:prose-invert">
                <p className="text-gray-700 dark:text-gray-300 leading-relaxed mb-6">
                  PsyBalans — это больше, чем цифровое приложение для самопомощи. Это научная лаборатория личного баланса, 
                ...
                <p className="text-gray-700 dark:text-gray-300 leading-relaxed">
                  ...
                  а не линия. PsyBalans — первый в мире сервис, который строит персональную экосистему заботы, 
            ...
            <CardContent className="p-8">
              ...
              <div className="mt-8 p-6 bg-gradient-to-r from-emerald-50 to-teal-50 dark:from-emerald-900/20 dark:to-teal-900/20 rounded-lg">
                <p className="text-gray-900 dark:text-white font-medium text-center">
                  Главная задача PsyBalans — научить использовать не "силу воли", а свои природные ритмы 
            ...
            <Card className="hover-lift dark:bg-gray-800 dark:border-gray-700">
              <CardContent className="p-6">
                ...
                <div className="space-y-3 text-gray-700 dark:text-gray-300 text-sm">
                  <p>PsyBalans не заменяет профессиональную помощь, а дополняет самостоятельную работу.</p>
          ...
          <Card className="hover-lift dark:bg-gray-800 dark:border-gray-700">
            <CardContent className="p-8">
              ...
              <p className="text-gray-700 dark:text-gray-300 mb-8 max-w-2xl mx-auto">
                PsyBalans создан для тех, кто ценит осознанность, науку и индивидуальный путь. 
