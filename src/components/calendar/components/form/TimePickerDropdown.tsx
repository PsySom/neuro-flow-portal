...
const TimePickerDropdown: React.FC<TimePickerDropdownProps> = ({
  ...
  return (
    <div
      ref={dropdownRef}
      className="fixed z-50 bg-white border border-gray-200 rounded-lg shadow-lg p-3 animate-in fade-in-0 zoom-in-95 duration-200"
      style={{
        top: position.top,
        left: position.left,
        width: '280px'
    ...
    >
      <div className="flex gap-3 mb-3">
        ...
        <div className="flex-1">
          <div className="text-center mb-2 font-medium text-sm">Часы</div>
              ...
              <div data-scroll-hour className="p-1">
                {hours.map((hour) => (
                  <div
                    key={hour}
                    data-value={hour}
                    className={`p-1.5 text-center cursor-pointer rounded text-sm hover:bg-gray-100 ${
        ...
        {/* Минуты */}
        <div className="flex-1">
          <div className="text-center mb-2 font-medium text-sm">Минуты</div>
          <div className="relative">
            <ScrollArea className="h-32 border rounded">
